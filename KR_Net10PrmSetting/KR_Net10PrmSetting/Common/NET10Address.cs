...
// NET10アドレス情報(読み出し用)
public struct NET10_SendAddressInfo
{
    public List<short> Addr;    // 書込アドレス
...
namespace KR_Net10PrmSetting
{
    ...
    public class NET10Address
    {
        ...
        // 変数
        public NET10_AddressInfo m_AddrInfo;            // NET10アドレス情報
        public NET10_SendAddressInfo m_SendAddrInfo;    // NET10送信アドレス情報
